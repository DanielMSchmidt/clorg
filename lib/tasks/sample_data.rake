  ...
  task :populate => :environment do
    ...
    99.times do |n|
      ...
      50.times do |time|
        ...
        user.messages.create!(:content => Faker::Lorem.sentence(5), :tag_id => tag)
      ...
      5.times do |time|
        ...
        user.events.create!(:tag_id => tag, :name => Faker::Lorem.sentence(1), :start_at => start_at, :end_at => end_at)
